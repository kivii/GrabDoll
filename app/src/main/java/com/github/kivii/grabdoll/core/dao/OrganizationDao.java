...
public class OrganizationDao extends AbstractDao<Organization, Long> {
    ...
    public static class Properties {
        ...
        public final static Property LogoId = new Property(5, Long.class, "logoId", false, "LOGO_ID");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Organization entity) {
        ...
        Long logoId = entity.getLogoId();
        if (logoId != null) {
            stmt.bindLong(6, logoId);
        }
    }
    ...
    public Organization readEntity(Cursor cursor, int offset) {
        Organization entity = new Organization( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // logoId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Organization entity, int offset) {
        ...
        entity.setLogoId(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(Organization entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM ORGANIZATION T");
            builder.append(" LEFT JOIN IMAGE T0 ON T.\"LOGO_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Organization loadCurrentDeep(Cursor cursor, boolean lock) {
        Organization entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        Image logo = loadCurrentOther(daoSession.getImageDao(), cursor, offset);
        entity.setLogo(logo);

        return entity;    
    }

    public Organization loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Organization> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<Organization> list = new ArrayList<Organization>(count);
    ...
    public List<Organization> queryDeep(String where, String... selectionArg) {
